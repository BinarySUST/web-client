        ...
        <div className="rbt-dashboard-content bg-color-white rbt-shadow-box">
            <div className="content">
                ...
                <div className="rbt-profile-row row row--15 mt--15">
                    ...
                    <div className="col-lg-8 col-md-8">
                        <div className="rbt-profile-content b2">I am the Front-End Developer for #Rainbow IT in Bangladesh, OR. I have serious passion for UI effects, animations and creating intuitive, dynamic user experiences.</div>
                    </div>
                </div>
                {/* End Profile Row  */}
            </div>
